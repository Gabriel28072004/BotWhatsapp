...
function Valida_Form(){
   ...
   document.forms["salvar_alteracoes_contato"].submit();
}
</script>
...
<div style="margin-left:30%;padding:1px 12px;height:10px;">
  ...
  <form action="alteracoes_contato.php" name="salvar_alteracoes_contato" method="post">
  Selecione o contato que deseja alterar.
  <br>
<select name="contato" id="contato" Size="5">
    <?php
    $busca_email = "SELECT telefone_contato,id_contato FROM contato";
